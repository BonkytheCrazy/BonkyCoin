(// Copyright (c) 2011-2016 The Cryptonote developer
...
const unsigned EMISSION_SPEED_FACTOR                         = 200;
...
2//TODO Define preferred block's target time
...
1Bconst size_t   MAX_BLOCK_SIZE_INITIAL                        =  20 * 1024;
...
const char     CRYPTONOTE_NAME[]                             = "bonkycoin";
